  ...
  public Result eval(@Nonnull final Result... inObj) {
    ...
    TensorArray wrap = new TensorArray(RefIntStream.range(0, batch.length()).parallel()
        .mapToObj(RefUtil.wrapInterface(
            (IntFunction<? extends Tensor>) dataIndex -> outputDims
            ...
            outputDims == null ? null : outputDims, batch == null ? null : batch.addRef()))
              ...
              TensorArray tensorArray = new TensorArray(RefIntStream.range(0, error.length()).parallel()
                  .mapToObj(RefUtil.wrapInterface(
                      (IntFunction<? extends Tensor>) dataIndex -> {
                        ...
                        err.coordStream(false).forEach(RefUtil.wrapInterface(
