...
/**
 * This class tests the PoincareDisk class.
 *
 * @docgenVersion 9
 */
public class PoincareDiskTest {
   ...
   * <p>
   * This test method tests the Polygon class by creating a Polygon object and testing its methods.
   * @docgenVersion 9
   */
  @Test
  ...
  /**
   * Test to check if the image is finished.
   *
...
//        image = ImageUtil.resize(image, size, size);
  ...
  /**
   * Test to reprocess images and save them in a new location
   *
   * @throws IOException
   * @docgenVersion 9
   */
  ...
  /**
   * Reprocesses the given file in the given base directory using the given hyperbolic polygon.
   *
   * @param baseDir the base directory to use
   * @param polygon the hyperbolic polygon to use
...
//            }
  ...
  /**
   * @Test public void testKlien() throws IOException;
   * @docgenVersion 9
   */
  @Test
   ...
   * <p>
   * This test will test the square function to see if it works correctly.
   * If the function does not work correctly, an IOException will be thrown.
   * @docgenVersion 9
   */
  @Test
   ...
   * @throws IOException if there is an error writing the image to a temporary file
   * @docgenVersion 9
   */
